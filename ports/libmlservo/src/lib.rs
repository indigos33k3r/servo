...
fn get_servo_key_from_keycode(keycode: u32) -> Key {
    ...
    match keycode {
        48 => Key::Character(String::from("0")),
        49 => Key::Character(String::from("1")),
        50 => Key::Character(String::from("2")),
        51 => Key::Character(String::from("3")),
        52 => Key::Character(String::from("4")),
        53 => Key::Character(String::from("5")),
        54 => Key::Character(String::from("6")),
        55 => Key::Character(String::from("7")),
        56 => Key::Character(String::from("8")),
        57 => Key::Character(String::from("9")),
        65 => Key::Character(String::from("a")),
        66 => Key::Character(String::from("B")),
        67 => Key::Character(String::from("c")),
        68 => Key::Character(String::from("d")),
        69 => Key::Character(String::from("e")),
        70 => Key::Character(String::from("f")),
        71 => Key::Character(String::from("g")),
        72 => Key::Character(String::from("h")),
        73 => Key::Character(String::from("i")),
        74 => Key::Character(String::from("j")),
        75 => Key::Character(String::from("k")),
        76 => Key::Character(String::from("l")),
        77 => Key::Character(String::from("m")),
        78 => Key::Character(String::from("n")),
        79 => Key::Character(String::from("o")),
        80 => Key::Character(String::from("p")),
        81 => Key::Character(String::from("q")),
        82 => Key::Character(String::from("r")),
        83 => Key::Character(String::from("s")),
        84 => Key::Character(String::from("t")),
        85 => Key::Character(String::from("u")),
        86 => Key::Character(String::from("v")),
        87 => Key::Character(String::from("w")),
        88 => Key::Character(String::from("x")),
        89 => Key::Character(String::from("y")),
        90 => Key::Character(String::from("z")),
        27 => Key::Escape,
        112 => Key::F1,
        113 => Key::F2,
        114 => Key::F3,
        ...
        40 => Key::ArrowDown,
        13 => Key::Enter,
        32 => Key::Character(String::from(" ")),
        9 => Key::Tab,
        8 => Key::Backspace,
        20 => Key::CapsLock,
        192 => Key::Character(String::from("`")),
        189 => Key::Character(String::from("-")),
        187 => Key::Character(String::from("=")),
        219 => Key::Character(String::from("[")),
        221 => Key::Character(String::from("]")),
        220 => Key::Character(String::from("\\")),
        186 => Key::Character(String::from(";")),
        222 => Key::Character(String::from("'")),
        188 => Key::Character(String::from(",")),
        190 => Key::Character(String::from(".")),
        191 => Key::Character(String::from("/")),
        16 => Key::Shift,
        17 => Key::Control,
        18 => Key::Alt,
        91 => Key::Meta,
